...
```
<list_creation> ::= <variable_name> "=" "liste" "!"
<list_add> ::= "listeye_ekle" "!" "liste" ":" <variable_name> "," "değer" ":" <expression>
<dict_creation> ::= <variable_name> "=" "sözlük" "!"
<dict_add> ::= "sözlüğe_ekle" "!" "sözlük" ":" <variable_name> "," "anahtar" ":" <string> "," "değer" ":" <expression>
```

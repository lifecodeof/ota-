...
<function_call> ::= <function_name> "!" <parameter_list> [ "eğer hatalıysa" <error_action> ]
                | <variable_name> "." <function_name> "!" <parameter_list> [ "eğer hatalıysa" <error_action> ]
...
```
<list_creation> ::= <variable_name> "=" "yeni" "liste"
<list_add> ::= <variable_name> "." "ekle" "!" "değer" ":" <expression>
<dict_creation> ::= <variable_name> "=" "yeni" "sözlük"
<dict_add> ::= <variable_name> "." "ekle" "!" "anahtar" ":" <string> "," "değer" ":" <expression>
```
...
```
<import> ::= "içer" <string>   # örn: içer "modul.otağ"
```
